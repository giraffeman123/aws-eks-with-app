...
module "vpc" {
  ...
  private_subnet_tags = {
    ...
    "karpenter.sh/discovery"                                  = local.constructed_cluster_name
  }
}
...
module "apps_config" {
  ...
  applications = {
    "fsa-stack" = {
      "namespace"         = "fsa-stack"
      "fsa_api_irsa_name" = "fsa-api-irsa-eks"
    }
  }
